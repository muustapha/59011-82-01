...
using APIfootball.Modèles.Données;
...
public partial class footbalDbContext : DbContext
{
    ...
    public virtual DbSet<Arbitrespartita> Arbitrespartita { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Arbitre>(entity =>
        {
            ...
            entity.Property(e => e.IdArbitre).HasColumnName("idArbitre");
        ...
        modelBuilder.Entity<Arbitrespartitum>(entity =>
        {
            ...
            entity.Property(e => e.IdArbitresPartita).HasColumnName("idArbitresPartita");
            entity.Property(e => e.IdArbitres).HasColumnName("idArbitres");
            entity.Property(e => e.IdPartita).HasColumnName("idPartita");
